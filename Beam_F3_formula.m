function [X,Y] = Beam_F3_formula(TT,NI,CF)
%====================================================================================================================
% This is function is used to calculate X and Y based on Beam F3 method - intended formula version.
% [input]:
...
A = (R2*sind(324)+R1/2)/R2*cosd(324);
B = R1*sind(288)/(R1*cosd(288)-R2/2);
x = 1/2*(R1-R2*B)/(A-B);
y = A*x-R1/2;
r = sqrt(x^2+y^2);
theta = atan(y/x);
